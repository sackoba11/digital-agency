...
export const Clients = () => {
  ...
  return (
    <div id='clients' className='w-full h-auto flex flex-col items-center
     ...
     bg-cover bg-center' style={{ backgroundImage: `url(${backgroundimage})` }}>
      <div data-aos='zoom-in' data-aos-delay='50' className='bg-white rounded-full 
      ...
      <div className='w-full grid lg:grid-cols-4 grid-cols-2 '>
         <div data-aos='slide-up' data-aos-delay='100' className='border-[0.5px] 
...
<div data-aos='slide-up' data-aos-delay='100' className='border-[0.5px] 
      ...
      </div><div data-aos='slide-up' data-aos-delay='100' className='border-[0.5px] 
       border-white lg:p-20 p-10 flex items-center justify-center '>
