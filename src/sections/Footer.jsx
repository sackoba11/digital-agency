...
import { FaPhoneVolume, FaFacebookF, FaTwitter, FaLinkedinIn, FaInstagram } from 'react-icons/fa' 

export const Footer = () => {
  return (
    <div className='w-full bg-black h-auto flex flex-col items-start justify-center 
    lg:px-[80px] px-[20px] lg:py-[50px] py-[30px] gap-[60px]'>
      <div className='w-full h-auto flex flex-col lg:flex-row items-start justify-between gap-[60px]'>
        <div className='lg:w-[40%] w-full flex flex-col justify-center items-start gap-[25px]'>
         ...
         <p className='text-gray-300 text-md font-poppins'>Feel free to call us in working hours mon - Fri 9:00 AM - 18:00. Our Team 
          will be happy to help answer your queries.</p>
          <div className='flex justify-center items-center gap-2 text-white'>
            {<FaPhoneVolume className='text-themegreen size-5' />} +225 0123456789
          </div>
        ...
        <div className='lg:w-[15%] w-full flex flex-col justify-center items-start gap-6'>
            ...
            <ul className='flex flex-col justify-center items-start gap-2'>
              ...
              <li className='text-gray-300 hover:text-themegreen cursor-pointer'>Our Projects</li>
            </ul>
          </div>
          <div className='lg:w-[15%] w-full flex flex-col justify-center items-start gap-6'>
            <h1 className='text-white text-[23px] capitalize leading-[1.2em] font-poppins' >Services</h1>
            <ul className='flex flex-col justify-center items-start gap-2'>
              <li className='text-gray-300 hover:text-themegreen cursor-pointer'>Cloud Solutions</li>
              <li className='text-gray-300 hover:text-themegreen cursor-pointer'>Cyber Security</li>
              <li className='text-gray-300 hover:text-themegreen cursor-pointer'>Pricing</li>
              <li className='text-gray-300 hover:text-themegreen cursor-pointer'>Blog</li>
              <li className='text-gray-300 hover:text-themegreen cursor-pointer'>Our Projects</li>
            </ul>
          ...
          <div className='flex flex-col justify-center items-start w-full'>
            <input type="text" placeholder='Enter your email address' className='w-full bg-transparent border-2 border-gray-800 p-4 rounded-md' />
