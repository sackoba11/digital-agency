...
useEffect(() => {
  ...
  return (
    <div id='hero' className='w-full h-auto flex lg:flex-row flex-col justify-between items-center 
    ...
    bg-cover bg-center' style={{ backgroundImage: `url(${backgroundimage})` }} >
      <div className='lg:w-1/2 w-full flex flex-col gap-[20px] items-start justify-center'>
        ...
        <p data-aos="zoom-in" data-aos-delay="170" className='text-gray-300 text-md font-poppins'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Velit porro officiis fugiat 
      ...
      <div className='lg:w-1/2 w-full flex justify-center items-center'>
        <div data-aos="zoom-in" data-aos-delay="230" className='lg:w-[80%] w-full flex justify-center items-center px-5 pt-5
